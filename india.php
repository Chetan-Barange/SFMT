...
<div class="pkg_slider">
    <div class="pkg_img_slides">
        ...
        <div class="pkg_slide first">
            <img src="images/womens_210322.jpg" alt="sakljgsdhvafjvsdagkhansdbkjvh"> 
        </div>
        <div class="pkg_slide">
...
<div class="package-container">
        ...
        ?>
        <div class="package">
          <img  src="admin/india_images/<?php echo $row['pkg_img']; ?>">
            <div class="package-header">
               ...
               <div class="more_details_section">
                <form class="more_details" action="moredetails.php" method="POST">
                    <input type="hidden" name="pkg_ind_id" value="<?php echo $row['pkgid']; ?>">
